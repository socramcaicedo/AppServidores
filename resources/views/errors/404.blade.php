...
<body>
    <div class="card">
        ...
        <p>
            La página que buscas no existe o fue movida. Verifica la dirección o vuelve
            a una sección conocida.
        </p>
        <div class="acciones">
            <a href="javascript:history.back()" class="btn btn-secundario">Volver atrás</a>
            <a href="{{ route('dashboard') }}" class="btn btn-primario">Ir al dashboard</a>
        </div>
    </div>
</body>
</html>
