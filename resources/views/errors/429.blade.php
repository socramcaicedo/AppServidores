...
<body>
    <div class="card">
        ...
        <p>
            Has intentado iniciar sesión demasiadas veces en muy poco tiempo.
            Por seguridad, debes esperar aproximadamente <strong>1 minuto</strong>
            antes de intentar nuevamente.
        </p>
        <p class="contador">Podrás volver a intentar en <span id="segundos">60</span> segundos…</p>
